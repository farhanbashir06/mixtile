...
var KTDatatableColumnWidthDemo = function() {
    ...
    //dashboard one
    var dash11 = function() {
        var datatable = $('#kt_datatable11').KTDatatable({
            // datasource definition
            data: {
                type: 'remote',
                source: {
    ...
    var dash12 = function() {
        var datatable = $('#kt_datatable12').KTDatatable({
            // datasource definition
            data: {
                type: 'remote',
                source: {
    ...
    var dash13 = function() {
        var datatable = $('#kt_datatable13').KTDatatable({
            // datasource definition
            data: {
                type: 'remote',
                source: {
    ...
    var dash14 = function() {
        var datatable = $('#kt_datatable14').KTDatatable({
            // datasource definition
            data: {
                type: 'remote',
                source: {
