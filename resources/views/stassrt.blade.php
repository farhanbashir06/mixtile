              ...
              <div class="col-12 ">
                <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid mycontainer">
                        <div class="row">
                            <div class="col-1">
                                <a class="navbar-brand" href="index.html"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                            </div>
                            <div class="col-10 text-center">
                               <a href="{{url('/')}}" class="logoh"><h2 >Saychizz</h2></a>
                            </div>
                            <div class="col-1" >
                                ...
                                <ul>
                                    ...
                                    <li  class="mt-3"><a href="giftcard.html" class="newlink"><span><i class="fas fa-gift"></i></span>Buy a Gift</a></li>
                                    <li  class="mt-3"><a href="contact.html" class="newlink"><span><i class="far fa-comment-dots"></i></span> Contact us</a></li>
                                </ul>
                                </div>
                                </div>
                            </div>
          ...
          <div class="modal fade" id="exampleModa5" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="row g-3" accept-charset="UTF-8" action="{{url('/stripe')}}" class="require-validation"
