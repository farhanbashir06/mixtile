            ...
            <!--end::Svg Icon-->
                ...
                <span class="svg-icon menu-icon">
                    ...
                    <!--end::Svg Icon-->
                                ...
                                <li class="menu-item menu-item-submenu {{request()->is('homepage')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Content Managment</span>
                                    ...
                                    <div class="menu-submenu" style="display: none; overflow: hidden;" kt-hidden-height="80">
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item menu-item-submenu {{request()->is('homepage')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
                                                <a href="{{route('homepage.index')}}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
